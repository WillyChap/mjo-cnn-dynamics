#!/bin/bash
#PBS -N perexpCNN_Diag
#PBS -A NAML0001
#PBS -l walltime=01:30:00
#PBS -o Paper_WCD/nc/run_CNN/perexp_CNN.out
#PBS -e Paper_WCD/nc/run_CNN/perexp_CNN.out
#PBS -q casper
...
# ---- experiment ----
TAG="CNN"
export modout="f.e.FTORCHmjo_fullCNN_DT2"
export mod_data_daily="/glade/campaign/cgd/amp/wchapman/ADF/${modout}/ts/${modout}.cam.h1.NC4_Classic.plev.mjo.1979010100000-1990123100000.nc"
